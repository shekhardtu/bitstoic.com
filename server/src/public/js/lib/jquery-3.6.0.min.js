...
!(function (e, t) {
      ...
      for (
        ...
        if ((t = b.relative[e[s].type])) c = [be(we(c), t)];
          ...
          if ((t = b.filter[e[s].type].apply(null, e[s].matches))[S]) {
            ...
            return Ce(
              s > 1 && we(c),
              s > 1 && xe(e.slice(0, s - 1).concat({ value: e[s - 2].type === ' ' ? '*' : '' })).replace($, '$1'),
              t,
              s < n && Ee(e.slice(s, n)),
              n < r && Ee((e = e.slice(n))),
              n < r && xe(e)
    ...
    if (void 0 === n && e.nodeType === 1)
      if (((r = `data-${t.replace(K, '-$&').toLowerCase()}`), typeof (n = e.getAttribute(r)) === 'string')) {
        try {
          n =
            (i = n) === 'true' ||
            (i !== 'false' && (i === 'null' ? null : i === `${+i}` ? +i : J.test(i) ? JSON.parse(i) : i));
        } catch (e) {}
        Q.set(e, t, n);
      } else n = void 0;
    return n;
        ...
        return $(
          ...
          function (e) {
            ...
            if (typeof e === 'string' && !ke.test(e) && !ge[(de.exec(e) || ['', ''])[1].toLowerCase()]) {
              e = S.htmlPrefilter(e);
              try {
                for (; n < r; n++) (t = this[n] || {}).nodeType === 1 && (S.cleanData(ve(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
  ...
  function Qe(e, t, n, r, i, o) {
    ...
    return (
      !r && o >= 0 && (u += Math.max(0, Math.ceil(e[`offset${t[0].toUpperCase()}${t.slice(1)}`] - o - u - s - 0.5)) || 0), u
    );
  }
  function Je(e, t, n) {
    const r = Re(e);
  ...
  S.extend({
    ...
    style(e, t, n, r) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        (o = typeof n) === 'string' && (i = te.exec(n)) && i[1] && ((n = se(e, t, i)), (o = 'number')),
          n != null &&
            n == n &&
      ...
      S.cssHooks[u] = {
        ...
        set(e, t, n) {
          ...
          return (
            ...
            s && (r = te.exec(t)) && (r[3] || 'px') !== 'px' && ((e.style[u] = t), (t = S.css(e, u))),
            Ye(0, t, s)
          );
        },
      };
    ...
    ((Ke.propHooks = {
      _default: {
        ...
        set(e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 || (!S.cssHooks[e.prop] && e.elem.style[ze(e.prop)] == null)
            ? (e.elem[e.prop] = e.now)
      ...
      attr(e, t, n) {
        ...
        if (o !== 3 && o !== 8 && o !== 2)
          return typeof e.getAttribute === 'undefined'
            ? S.prop(e, t, n)
            : ((o === 1 && S.isXMLDoc(e)) || (i = S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? ct : void 0)),
              void 0 !== n
                ? n === null
  ...
  S.fn.extend({
    ...
    S.fn.extend({
      ...
      hasClass(e) {
        ...
        let r = 0;
        t = ` ${e} `;
        while ((n = this[r++])) if (n.nodeType === 1 && ` ${ht(gt(n))} `.indexOf(t) > -1) return !0;
        return !1;
      },
    });
  const yt = /\r/g;
  ...
  function At(n, e, r, i) {
    ...
    if (Array.isArray(e))
      S.each(e, function (e, t) {
        r || Ct.test(n) ? i(n, t) : At(`${n}[${typeof t === 'object' && t != null ? e : ''}]`, t, r, i);
      });
  ...
  (Mt.href = bt.href),
    S.extend({
      ...
      ajax(e, t) {
        ...
        if (
          (v.data && v.processData && typeof v.data !== 'string' && (v.data = S.param(v.data, v.traditional)),
          Wt(Ot, v, t, T),
          h)
        )
          return T;
